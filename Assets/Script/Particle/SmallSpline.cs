...
public struct SmallSpline
{
    private List<Vector3> m_listRoute_Pos;
    //현재 지나는 카메라 경로
    private int m_iRoute_Cur;
    //최대 카메라 경로 수
    private int m_iRoute_Max;
    private Vector3 m_vPosCur;
    private Vector3 m_vPosF;
    private Vector3 m_vPosB;
    //방향
    ...
    //러프 속도
    private float m_fLerpSpeed;
    //스플라인 폭
    private float m_fCurvePower;
    // 스플라인 사이즈
    ...
    public void Initialize(Vector3 vStartPos)
    {
        ...
        /*for (int i = 0; i < m_iRoute_Max; ++i)
        {
            if (i == 0)
                ...
                m_listRoute_Pos.Add(m_listRoute_Pos[i - 1] + MM.FloatToVector(
                    Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f,
                    Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f, 
                    Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f));
        }*/
        ...
        if (m_iRoute_Cur > m_iRoute_Max - 3)
        {
            ...
            /*for (int i = 0; i < m_iRoute_Max; ++i)
            {
                if (i < m_iRoute_Max - 1)
                    ...
                    m_listRoute_Pos[i] = m_listRoute_Pos[i] + MM.FloatToVector(Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f,
                        Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f, Random.Range(0f, m_fCurvePower) - m_fCurvePower * 0.5f);
            }*/
